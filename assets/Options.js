...
onload = ()=>{
  ...
  if (["/LibrarySource/index.html","/LibrarySource/","/CPQuerySource/","/CPQuerySource/index.html"].indexOf(location.pathname)>-1) hljs.initHighlighting();
}